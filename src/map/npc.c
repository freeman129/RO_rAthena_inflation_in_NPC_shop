...
#ifdef RENEWAL_INFLATION
		z += value * amount;
		z += itemdb_inflation_arithmetic_progression(nameid, amount, buyorsell);
#else
...
#ifdef RENEWAL_INFLATION
	if(itemdb_inflation_update(item_list, n, buyorsell))
...
#ifdef RENEWAL_INFLATION
	if(itemdb_inflation_update(item_list_inflation, (n - n_minus), buyorsell))
		printf("Inflation update error\n");
#endif
